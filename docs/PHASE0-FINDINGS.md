...
- Invariants + tests protect against VITE\_ secret leaks and client serverFn misuse.
...
- Routes: dashboard, projects.new/upload/analysis/estimate/report/$id, deal-copilot/new, \_authed, \_\_root.
...
_Generated during agent exploration. Update before final report._
