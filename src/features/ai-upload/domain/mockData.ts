/**
 * AI-upload slice — Deterministic mock analysis data (dev / no-API-key fallback).
 *
 * No IO — uses bundled asset URLs for demo photos when none are supplied.
 */
import beforeImg from "@/assets/before.jpg";
import afterImg from "@/assets/after.jpg";
import heroImg from "@/assets/hero-after.jpg";
import type { AnalysisPhotoSource, RoomAnalysis } from "./types";
