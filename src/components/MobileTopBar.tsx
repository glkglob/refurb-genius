...
export function MobileTopBar() {
  ...
  return (
    <header
      className="sticky top-0 z-30 w-full border-b border-border bg-background/95 backdrop-blur supports-[padding:max(0px)]:pt-[env(safe-area-inset-top)] md:hidden"
      data-testid="mobile-top-bar"
    >
      <div className="flex h-14 items-center gap-1 px-1.5" data-testid="mobile-top-bar-row">
        <Link
          to="/dashboard"
