...
function ProjectsIndexPage() {
  ...
  return (
    <AppLayout showDealCopilotRail>
      <div className="flex min-w-0 max-w-full flex-col gap-8 pt-2 pb-10">
        <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <h1 className="font-serif min-w-0 break-words text-xl font-semibold tracking-tight text-foreground sm:text-3xl">
            Projects
          </h1>
