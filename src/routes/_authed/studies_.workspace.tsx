...
export const Route = createFileRoute("/_authed/studies_/workspace")({
  head: () => ({ meta: [{ title: "Feasibility workspace — Refurb Genius (compatibility)" }] }),
...
function AnalyzeRoute() {
  ...
  return (
    <AppLayout
      ...
      subtitle="Compatibility surface for guided feasibility snapshots. Canonical New Analysis is /analyze (project entry → Photos)."
      actions={
        <div className="flex flex-wrap gap-2">
          {selectedProject ? (
            ...
            <Button asChild size="touch" variant="default">
              <Link to="/analyze" data-testid="analyze-new-project-entry">
