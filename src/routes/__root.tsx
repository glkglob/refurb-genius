...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // Apple sign-in is handled via Supabase OAuth; no Apple JS meta tags are required.
      {
  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        <Scripts />
        {/* Apple sign-in is handled via Supabase OAuth; the Apple JS SDK is not required here. */}
      </body>
    </html>
  );
}
