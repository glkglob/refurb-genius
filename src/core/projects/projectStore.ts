...
// complete.
//
// C4b: canonical runtime owner under core. Compatibility re-exports live in
// src/lib/projects.ts. Pure domain types/helpers live in ./domain (C4a).
import { supabase } from "@/platform/supabase/browser";
import { auth } from "@/lib/auth";
import { captureApiError, addDiagnosticBreadcrumb } from "@/lib/sentry";
