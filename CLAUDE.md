...
- **IA programme:** For IA-1–IA-10 follow the LOCKED IA-0 workflow contract at `docs/architecture/workflow/ia-0-workflow-authority-spec.md` (see AGENTS.md “IA workflow programme”). IA-1 is **Completed** on main. Do not begin IA-2 without explicit authorisation.
